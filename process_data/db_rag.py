...
COLLECTION_NAME = chroma_client.get_or_create_collection(name="bjs_col")
...
def embedding_filter(chunks, embeddings):
    ...
    texts = [c.page_content for c in dense_chunks]
...
if __name__ == "__main__":
    ...
    if COLLECTION_NAME in existing_collections:
        # Collection exists, no need to process PDF again
        print(f"Collection '{COLLECTION_NAME}' already exists. Using cached data.")
        collection = client.get_collection(COLLECTION_NAME)
    else:
        # Collection doesn't exist, process PDF and add
        print(f"Collection '{COLLECTION_NAME}' not found. Processing PDF...")
        docs = load_documents()
